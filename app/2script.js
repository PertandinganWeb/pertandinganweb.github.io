...
function showPopup() {
    ...
    document.getElementById('bibleVerse').innerText = randomVerse;
    document.getElementById('popupModal').style.display = 'flex'; // Use flex to center align
}

// Event listener for the OK button to close the popup
